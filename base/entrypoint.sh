...
if [ -n "$SECRET_BASE" ]; then
    ...
    echo "Derived secrets:"
    echo "CLICKHOUSE_PASSWORD: $CLICKHOUSE_PASSWORD"
    echo "CLICKHOUSE_BACKEND_PASSWORD: $CLICKHOUSE_BACKEND_PASSWORD"
    echo "CLICKHOUSE_DASHBOARD_PASSWORD: $CLICKHOUSE_DASHBOARD_PASSWORD"
    echo "POSTGRES_PASSWORD: $POSTGRES_PASSWORD"
    echo "POSTGRES_SITECONFIG_RO_PASSWORD: $POSTGRES_SITECONFIG_RO_PASSWORD"
    echo "NEXTAUTH_SECRET: $NEXTAUTH_SECRET"
    echo "TOTP_SECRET_ENCRYPTION_KEY: $TOTP_SECRET_ENCRYPTION_KEY"
    echo "POSTGRES_URL: $POSTGRES_URL"
    echo "SITE_CONFIG_DATABASE_URL: $SITE_CONFIG_DATABASE_URL"
fi
