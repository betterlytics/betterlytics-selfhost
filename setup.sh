...
echo ""
echo "  2. Open ${ACCESS_URL}/signup in your browser"
echo "     and create your account. The first account"
echo "     becomes the instance admin, even though open"
echo "     registration is disabled. Create it before"
echo "     sharing the URL with anyone else."
echo ""
echo "-------------------------------------------"
